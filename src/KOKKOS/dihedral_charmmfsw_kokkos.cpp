...
void DihedralCharmmfswKokkos<DeviceType>::init_style()
{
  ...
  int n = atom->ntypes;
  DAT::tdual_kkfloat_2d k_lj14_1("DihedralCharmmfsw:lj14_1",n+1,n+1);
  DAT::tdual_kkfloat_2d k_lj14_2("DihedralCharmmfsw:lj14_2",n+1,n+1);
  DAT::tdual_kkfloat_2d k_lj14_3("DihedralCharmmfsw:lj14_3",n+1,n+1);
  DAT::tdual_kkfloat_2d k_lj14_4("DihedralCharmmfsw:lj14_4",n+1,n+1);
