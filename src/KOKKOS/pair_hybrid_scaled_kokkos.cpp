...
void PairHybridScaledKokkos::compute(int eflag, int vflag)
{
  int i, j, m, n;
...
void PairHybridScaledKokkos::settings(int narg, char **arg)
{
...
double PairHybridScaledKokkos::single(int i, int j, int itype, int jtype, double rsq, double factor_coul,
...
void PairHybridScaledKokkos::born_matrix(int i, int j, int itype, int jtype, double rsq,
...
void PairHybridScaledKokkos::write_restart(FILE *fp)
{
...
void PairHybridScaledKokkos::read_restart(FILE *fp)
{
...
int PairHybridScaledKokkos::pack_forward_comm(int n, int *list, double *buf, int /*pbc_flag*/, int * /*pbc*/)
{
  int i,j,m;
...
void PairHybridScaledKokkos::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
