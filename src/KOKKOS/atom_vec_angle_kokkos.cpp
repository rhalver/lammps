...
void AtomVecAngleKokkos::sync_pinned(ExecutionSpace space, uint64_t mask, int async_flag)
{
  if (space == Device) {
...
void AtomVecAngleKokkos::modified(ExecutionSpace space, uint64_t mask)
{
  if (space == Device) {
