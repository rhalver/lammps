...
* Nevery = sample bond-order every this many Markdown Preview EnhancedMarkdown Preview Enhancedtimesteps
...
.. code-block:: json

   {
       "application": "LAMMPS",
       "format": "output",
       "subformat": "fix reaxff/species: delete keyword",
       "revision": 1,
       "run_output": [
           {
               "timestep": 1,
...
and the "type" values are atom types.  In the above example, the types were
reported as strings corresponding to elements using :doc:`type labels
<labelmap>`.
